...
|[ecqm-content-qicore-2024](https://github.com/cqframework/ecqm-content-qicore-2024)|This repository contains 2024AU content built using the QICore model. Measure content in this repository was exported from the MADiE tool.|Active|[CI Build](http://build.fhir.org/ig/cqframework/ecqm-content-qicore-2024)|
