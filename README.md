...
|----|----|----|----|
|[dqm-content-cms-2026](https://github.com/cqframework/dqm-content-cms-2026)|This repository contains example dQM content built using the USQualityCore 0.5.0, US Core 6.1.0-derived, and CarinBB 2.1.1 models. The examples have been developed purely for testing purposes to demonstrate the use of US Quality Core, as well as advanced dQM measure specification capabilities. Measure content in this repository was developed manually using the VSCode CQL Authoring plugin.|Draft|[CI Build](http://build.fhir.org/ig/cqframework/dqm-content-cms-2026)|
...
|[dqm-content-qicore-2025-subset](https://github.com/cqframework/dqm-content-qicore-2025-subset)|This repository contains a focused testing subset of the draft 2025AU content built using MADiE against the QICore 6.0.0 model. All measure content in this repository was developed in the MADiE tool and exported as FHIR bundles that are then placed as source for a FHIR content implementation guide, including tests developed in MADiE and exported to the appropriate test directories so the tests can be run in the VSCode CQL Authoring plugin.|Active|[CI Build](http://build.fhir.org/ig/cqframework/dqm-content-qicore-2025-subset)|
|[ecqm-content-qicore-2025](https://github.com/cqframework/ecqm-content-qicore-2025)|This repository contains draft 2025AU content built using the QICore 6.0.0 model. Measure content in this repository was updated from measure packages initially exported from the MADiE tool, then uplifted to QICore 6.0.0 using the VSCode CQL Authoring plugin.|Retired|[CI Build](http://build.fhir.org/ig/cqframework/ecqm-content-qicore-2025)|
|[dqm-content-cms-2024](https://github.com/cqframework/dqm-content-cms-2024)|This repository contains a subset of the content in the 2024 repository specifically built to support testing at the CMS Quality Conference.|Active|[CI Build](http://build.fhir.org/ig/cqframework/dqm-content-cms-2024)|
|[ecqm-content-qicore-2024-subset](https://github.com/cqframework/ecqm-content-qicore-2024-subset)|This repository contains a subset of the content in the 2024 repository, focused on supporting the testing of measure release packaging. See the Manifest library examples in this repository for examples of measure release packages in the authoring, testing, and final release publication stages of the AU authoring process.|Active|[CI Build](http://build.fhir.org/ig/cqframework/ecqm-content-qicore-2024-subset)|
|[ecqm-content-qicore-2024](https://github.com/cqframework/ecqm-content-qicore-2024)|This repository contains 2024AU content built using the QICore 4.1.1 model. Measure content in this repository was exported from the MADiE tool. NOTE: For the January 2025 Connectathon specifically, some of the measures in this repository have been updated with draft changes for the 2025AU cycle, but are still using QICore 4.1.1.|Active|[CI Build](http://build.fhir.org/ig/cqframework/ecqm-content-qicore-2024)|
|[ecqm-content-qicore-2023](https://github.com/cqframework/ecqm-content-qicore-2023)|This repository contains 2023AU content built using the QICore model. Measure content in this repository was exported from the MADiE tool.|Retired|[CI Build](http://build.fhir.org/ig/cqframework/ecqm-content-qicore-2023)|
|[ecqm-content-qicore-2022](https://github.com/cqframework/ecqm-content-qicore-2022)|This repository contains 2022AU content built using the QICore model, as opposed to FHIR directly. Measure content in this repository is intended to be able to imported into the MADIE tool, but not MAT-on-FHIR.|Retired|[CI Build](http://build.fhir.org/ig/cqframework/ecqm-content-qicore-2022)|
|[ecqm-content-qicore-2021](https://github.com/cqframework/ecqm-content-qicore-2021)|This repository contains 2021AU content built using the FHIR model, but with QICoreElements libraries that facilitate accessing extensions defined in QICore. Measure content in this repository is exploratory in nature and is not intended to be able to be imported in MADIE or MAT-on-FHIR, only to support past connectathon usage. All current development efforts should be focused on the qicore-2022 repository. |Retired|[CI Build](http://build.fhir.org/ig/cqframework/ecqm-content-qicore-2021)|
|[ecqm-content-qicore-2020](https://github.com/cqframework/ecqm-content-qicore-2020)|This repository contains 2020AU content built using the QICore model, as opposed to FHIR directly. Measure content in this repository is intended to be able to imported in MADIE, but not MAT-on-FHIR. |Retired|[CI Build](http://build.fhir.org/ig/cqframework/ecqm-content-qicore-2020)|
|[ecqm-content-r4-2022](https://github.com/cqframework/ecqm-content-r4-2022)|This repository contains 2022AU content for FHIR R4. Measure content in this repository should **not** make use of fluent functions to ensure that the libraries can be added to MAT-on-FHIR.|Retired|[CI Build](http://build.fhir.org/ig/cqframework/ecqm-content-r4-2022)|
|[ecqm-content-r4-2021](https://github.com/cqframework/ecqm-content-r4-2021)|This repository contains 2021AU content for FHIR R4.|Retired|[CI Build](http://build.fhir.org/ig/cqframework/ecqm-content-r4-2021)|
|[ecqm-content-r4](https://github.com/cqframework/ecqm-content-r4)|This repository contains 2020AU measure content for FHIR R4.|Retired|[CI Build](http://build.fhir.org/ig/cqframework/ecqm-content-r4)|
|[draft-measures](https://github.com/cqframework/draft-measures)|This is the first draft measures repository and contains 2019AU and some 2020AU measure content for FHIR DSTU2, STU3, and R4.|Retired|[CI Build](http://build.fhir.org/ig/cqframework/draft-measures)|
...
* Draft - The content in the repository is under active development and changes frequently
* Active - The content in the repository is considered stable and supporting direct testing. Although fixes will be applied, the content is not under active development and does not change frequently
* Retired - The content in the repository is no longer being updated and it provided solely for historical and legacy testing support
